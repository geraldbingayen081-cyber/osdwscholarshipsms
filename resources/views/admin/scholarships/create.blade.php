<x-app-layout title="Create Scholarship - CSU–Lal-lo">
    <x-slot name="header">
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-xs border border-slate-200 p-6 sm:p-8">
        <div class="mb-6 border-b border-slate-200 pb-4">
            <h3 class="text-base font-bold text-slate-800">New Scholarship Program</h3>
            <p class="text-xs text-slate-500 mt-1">Configure program details, grant terms, available slots, and application period.</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.scholarships.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input 
                        ...
                        placeholder="e.g. CSU Academic Excellence Grant"
                    >
                    @error('name')
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="e.g. CHED / CSU OSDW / LGU Lal-lo"
                    >
                    @error('provider')
                        <p class="mt-1 text-xs text-red-600 font-medium">{{ $message }}</p>
                    @enderror
            ...
            <div>
                ...
                <textarea 
                    ...
                    placeholder="Provide a overview of the scholarship program objectives and eligibility criteria..."
            ...
            <div>
                ...
                <textarea 
                    ...
                    placeholder="e.g. 100% Tuition Fee Discount + Monthly Book Allowance of PHP 2,500"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('max_household_income') }}" 
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('application_start_date', date('Y-m-d')) }}" 
                        required 
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="coverage_type" id="coverage_type" required class="w-full px-3 py-2 rounded-lg border @error('coverage_type') border-red-500 bg-red-50 @else border-slate-300 @enderror text-sm focus:ring-csu-green focus:border-csu-green">
                        <option value="continuing" {{ old('coverage_type', 'continuing') === 'continuing' ? 'selected' : '' }}>
                            Continuing / Multi-Year (e.g. 1st–4th Year, periodic compliance per semester)
                        </option>
                        <option value="annual" {{ old('coverage_type') === 'annual' ? 'selected' : '' }}>
                ...
                <div>
                    <label for="status" class="block text-xs font-semibold text-slate-700 mb-1">
                        Initial Program Status <span class="text-red-500">*</span>
                    </label>
                    <select name="status" id="status" required class="w-full px-3 py-2 rounded-lg border border-slate-300 text-sm focus:ring-csu-green focus:border-csu-green">
                        ...
                        <option value="open" {{ old('status') === 'open' ? 'selected' : '' }}>Open (Accepting Student Applications)</option>
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-slate-200">
                <a href="{{ route('admin.scholarships.index') }}" class="px-4 py-2 text-xs font-bold text-slate-600 hover:text-slate-800">
                    Cancel
                </a>
